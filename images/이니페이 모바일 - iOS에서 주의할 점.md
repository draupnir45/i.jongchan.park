# 이니페이 모바일 - iOS에서 주의할 점

이니페이 모바일은 앱 내에서 웹뷰를 이용해 결제 서비스를 제공할 수 있도록 하는데요. 직접 붙이면서 배운 점을 정리해 보았습니다.
...
- 일단 잘 동작하긴 하지만, 정상적인 방법인지 확신은 없습니다.

### httpBody의 EUC_KR 인코딩
- 위의 `P_RESERVED`를 담은 전체 파라미터는 웹뷰 리퀘스트의 바디에 들어가게 됩니다. 해당 부분은 EUC-KR로 인코딩 해야 하는데요.(하래요. 저도 하기 싫어요.) 아래와 같은 코드로 가능합니다.
